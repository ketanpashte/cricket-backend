...
public final class MatchResult {
    ...
    @JsonCreator
    public MatchResult(
        @JsonProperty("resultType") MatchResult.ResultType resultType,
        @JsonProperty("winningTeam") @Nullable LineUp winningTeam,
        @JsonProperty("wonBy") @Nullable Measure wonBy,
        @JsonProperty("wonByAmount") @Nullable Integer wonByAmount,
        @JsonProperty("duckworthLewisApplied") boolean duckworthLewisApplied
    ) {
     ...
     *  method which may in fact disagree with the result
