...
public final class Match {
    ...
    public enum State {
        NOT_STARTED,   TOSS_COMPLETED, IN_PROGRESS, COMPLETED
    }
    ...
    public Score scoredByTeam(LineUp<?> team) {
        ...
        for (Innings innings : list) {
            if (innings.battingTeam().teamName().equals(team.teamName())) {
     ...
     * @throws NoSuchElementException An invalid line-up was given
     */
