...
import static org.example.BattingState.DISMISSED;
import static org.example.BattingState.RETIRED_OUT;
...
public final class BatterInningsCompletedEvent extends BaseMatchEvent {
    ...
    @JsonCreator
    public BatterInningsCompletedEvent(
        ...
        @JsonProperty("reason") BattingState reason,
