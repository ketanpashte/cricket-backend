...
import static org.example.Crictils.requireInRange;
...
public final class InningsStartingEvent extends BaseMatchEvent {
    ...
    public InningsStartingEvent(
        ...
        @JsonProperty("startingScore") Score startingScore,
        @JsonProperty("battingTeam") LineUp battingTeam,
        @JsonProperty("bowlingTeam") LineUp bowlingTeam,
        @JsonProperty("maxBalls") @Nullable Integer maxBalls,
        @JsonProperty("maxOvers") @Nullable Integer maxOvers,
        @JsonProperty("target") @Nullable Integer target,
        @JsonProperty("isFollowingOn") boolean isFollowingOn,
        @JsonProperty("inningsNumberForMatch") int inningsNumberForMatch,
        @JsonProperty("inningsNumberForBattingTeam") int inningsNumberForBattingTeam,
        @JsonProperty("isFinalInnings") boolean isFinalInnings
    ) {
    ...
    public static final class Builder extends BaseMatchEventBuilder<Builder, InningsStartingEvent> {
        ...
        public @Nullable Integer inningsNumberForMatch() {
            return inningsNumberForMatch;
        }

        public @Nullable Integer inningsNumberForBattingTeam() {
            return inningsNumberForBattingTeam;
        }

        public @Nullable Boolean finalInnings() {
            return finalInnings;
        }
