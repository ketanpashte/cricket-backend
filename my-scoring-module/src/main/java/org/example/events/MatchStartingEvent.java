...
import static org.example.Crictils.requireNonNullElseGet;
...
public final class MatchStartingEvent extends BaseMatchEvent {
    ...
    MatchStartingEvent(
                       ...
                       @JsonProperty("scheduledStartTime") Instant scheduledStartTime,
                       @JsonProperty("lineUps") ImmutableList<LineUp<?>> lineUps,
                       @JsonProperty("inningsPerTeam") int inningsPerTeam,
                       @JsonProperty("oversPerInnings") Integer oversPerInnings,
                       @JsonProperty("numberOfScheduledDays") int numberOfScheduledDays,
                       @JsonProperty("ballsPerInnings") Integer ballsPerInnings,
