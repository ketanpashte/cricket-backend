...
public final class OverCompletedEvent extends BaseMatchEvent {
    ...
    public OverCompletedEvent(
        ...
        @JsonProperty("inningsNumber") int inningsNumber,
        @JsonProperty("overNumber") int overNumber,
        @JsonProperty("ballsInOver") int ballsInOver,
        @JsonProperty("score") Score score,
        @JsonProperty("isMaiden") boolean isMaiden
    ) {
    ...
    public static final class Builder extends BaseMatchEventBuilder<Builder, OverCompletedEvent> {
        ...
        public Builder apply(@Nonnull Match match) {
            ...
            if (innings == null)
                throw new IllegalStateException("Cannot complete an over when there is no innings in progress");
            Over over = innings.currentOver();
            if (over == null)
                throw new IllegalStateException("Cannot complete an over when there is no over in progress");
