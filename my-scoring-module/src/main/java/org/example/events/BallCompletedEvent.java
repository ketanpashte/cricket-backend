...
public class BallCompletedEvent extends BaseMatchEvent {
    ...
    public BallCompletedEvent(
        ...
        @JsonProperty("bowler") Player bowler,
        @JsonProperty("striker") Player striker,
        @JsonProperty("nonStriker") Player nonStriker,
        @JsonProperty("runsScored") Score runsScored,
        @JsonProperty("playersCrossed") boolean playersCrossed,
        @JsonProperty("dismissal") @Nullable Dismissal dismissal,
        @JsonProperty("delivery") @Nullable Delivery delivery,
        @JsonProperty("swing") @Nullable Swing swing,
        @JsonProperty("trajectoryAtImpact") @Nullable Trajectory trajectoryAtImpact,
        @JsonProperty("fielder") @Nullable Player fielder,
        @JsonProperty("overNumber") int overNumber,
        @JsonProperty("numberInOver") int numberInOver,
        @JsonProperty("numberInMatch") int numberInMatch
    ) {
